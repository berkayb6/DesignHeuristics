                    ...
                    <div className="container" >
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            ...
                            <NavItem className='col-12 col-md-7' style={{alignItems:'center', justifyContent:'center', display:'flex'}}>
                                <NavLink className="nav-link" onClick={this.logClick("tutorialsClicked")} to="/tutorial" style={{color:"black"}}>
                                    <span className='fa-lg' ><strong>Tutorials & Didactics</strong></span>
                                </NavLink>
                            </NavItem>
                            <NavItem className='col-12 col-md-7' style={{alignItems:'center', justifyContent:'center', display:'flex'}}>
                                <NavLink className="nav-link" onClick={this.logClick("feedbackClicked")} to="/feedback" style={{color:"black"}}>
                                    <span className='fa-lg' ><strong>Feedback</strong></span>
                                </NavLink>
                            </NavItem>
                            </Nav>
